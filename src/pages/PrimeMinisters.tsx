    ...
    <div className="space-y-6">
      ...
      <div className="glass rounded-2xl p-4">
        ...
        <ResponsiveContainer width="100%" height={450}>
          <BarChart data={compareData} layout="vertical" margin={{ left: 5, right: 30, top: 10, bottom: 10 }}>
            ...
            <YAxis type="category" dataKey={window.innerWidth < 640 ? "shortDisplayName" : "displayName"} tick={{ fill: 'currentColor', fontSize: window.innerWidth < 640 ? 10 : 12 }} className="text-slate-700 dark:text-white/60" width={window.innerWidth < 640 ? 100 : 180} />
            <Tooltip
