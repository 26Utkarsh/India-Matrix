...
export default function DigitalPage() {
  ...
  if (pmEraMode && activePMId) {
    ...
    if (pm) {
      data = DIGITAL_DATA.filter(d => d.year >= pm.start_year && d.year <= pm.end_year);
    }
  } else {
  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="glass rounded-2xl p-6 border-l-4 border-l-cyan-600 dark:border-l-cyan-400 relative overflow-hidden flex flex-row items-center justify-between gap-4">
